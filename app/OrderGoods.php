...
class OrderGoods extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['order_id', 'category_id', 'category_name', 'goods_id', 'goods_name', 'price_level', 'goods_price', 'price_rebate', 'total_price', 'goods_num', 'created_at', 'updated_at'];
